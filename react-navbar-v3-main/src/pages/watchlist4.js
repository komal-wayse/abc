...
import {AddWatchlist4} from './AddWatchlist4';
...
class about extends Component{
  ...
  refreshList(){
    fetch('http://localhost:62141/api/watchlist5')
...
componentDidMount(){
  ...
  deleteDep(W1_ID){
    if(window.confirm('Are you sure')){
      fetch(process.env.REACT_APP_API+'watchlist5/'+W1_ID,{
        method:'DELETE',
       ...
       <h4>Watchlist5 <br></br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <FaPlus className="icon" variant ='primary' size="30px" color="blue" 
          onClick={()=>this.setState({addModalShow:true})}>
            ...
            <AddWatchlist4 show={this.state.addModalShow}
