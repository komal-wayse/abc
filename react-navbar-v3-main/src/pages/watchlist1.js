...
import {AddWatchlist1} from './AddWatchlist1';
...
class about extends Component{
  ...
  refreshList(){
    fetch('http://localhost:62141/api/watchlist2')
...
componentDidMount(){
  ...
  deleteDep(W1_ID){
    if(window.confirm('Are you sure')){
      fetch(process.env.REACT_APP_API+'watchlist2/'+W1_ID,{
        method:'DELETE',
       ...
       <h4>Watchlist2 <br></br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <FaPlus className="icon" variant ='primary' size="30px" color="blue" 
          onClick={()=>this.setState({addModalShow:true})}>
            ...
            <AddWatchlist1 show={this.state.addModalShow}
