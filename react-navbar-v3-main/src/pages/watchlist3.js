...
import {AddWatchlist3} from './AddWatchlist3';
...
class about extends Component{
  ...
  refreshList(){
    fetch('http://localhost:62141/api/watchlist4')
...
componentDidMount(){
  ...
  deleteDep(W1_ID){
    if(window.confirm('Are you sure')){
      fetch(process.env.REACT_APP_API+'watchlist4/'+W1_ID,{
        method:'DELETE',
       ...
       <h4>Watchlist4 <br></br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <FaPlus className="icon" variant ='primary' size="30px" color="blue" 
          onClick={()=>this.setState({addModalShow:true})}>
            ...
            <AddWatchlist3 show={this.state.addModalShow}
