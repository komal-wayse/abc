...
import {AddWatchlist2} from './AddWatchlist2';
...
class about extends Component{
  ...
  refreshList(){
    fetch('http://localhost:62141/api/watchlist3')
...
componentDidMount(){
  ...
  deleteDep(W1_ID){
    if(window.confirm('Are you sure')){
      fetch(process.env.REACT_APP_API+'watchlist3/'+W1_ID,{
        method:'DELETE',
       ...
       <h4>Watchlist3 <br></br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <FaPlus className="icon" variant ='primary' size="30px" color="blue" 
          onClick={()=>this.setState({addModalShow:true})}>
            ...
            <AddWatchlist2 show={this.state.addModalShow}
